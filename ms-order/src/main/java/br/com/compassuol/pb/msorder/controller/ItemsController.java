...
public class ItemsController {
    ...
    public ResponseEntity<ItemsDtoResponse> save(@Valid @RequestBody ItemsDtoRequest request){
    ...
    public ResponseEntity<ItemsDtoResponse> update(@Valid @PathVariable("idOrder") ObjectId idOrder, @PathVariable("idItem")
